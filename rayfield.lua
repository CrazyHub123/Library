...
local Rayfield = game:GetObjects("rbxassetid://18848240266")[1]
...
function RayfieldLibrary:Notify(NotificationSettings)
	spawn(function()
		...
		if NotificationSettings.Actions then
			for _, Action in pairs(NotificationSettings.Actions) do
				...
				NewAction.MouseButton1Click:Connect(function()
					...
					if not Success then
						warn("Rayfield | Action: "..Action.Name.." Callback Error " ..tostring(Response))
					end
		...
		repeat task.wait() until ActionCompleted
...
function Unhide()
	...
	Main.Visible = true
	TweenService:Create(Main, TweenInfo.new(0.5, Enum.EasingStyle.Quint), {Size = UDim2.new(0, 464, 0, 440)}):Play()
	TweenService:Create(Main.Topbar, TweenInfo.new(0.5, Enum.EasingStyle.Quint), {Size = UDim2.new(0, 464, 0, 45)}):Play()
...
function Maximise()
	...
	TweenService:Create(Main, TweenInfo.new(0.5, Enum.EasingStyle.Quint), {Size = UDim2.new(0, 464, 0, 440)}):Play()
	TweenService:Create(Topbar, TweenInfo.new(0.5, Enum.EasingStyle.Quint), {Size = UDim2.new(0, 464, 0, 45)}):Play()
...
function Minimise()
	...
	TweenService:Create(Main, TweenInfo.new(0.5, Enum.EasingStyle.Quint), {Size = UDim2.new(0, 464, 0, 45)}):Play()
	TweenService:Create(Topbar, TweenInfo.new(0.5, Enum.EasingStyle.Quint), {Size = UDim2.new(0, 464, 0, 45)}):Play()
...
function RayfieldLibrary:CreateWindow(Settings)
	...
	if Settings.KeySystem then
		...
		if Settings.KeySettings.GrabKeyFromSite then
			...
			if not Success then
				warn("Rayfield | "..Settings.KeySettings.Key.." Error " ..tostring(Response))
			end
		end
	...
	function Window:CreateTab(Args)
		...
		if Image then
			...
			TabButton.Image.Image = "rbxassetid://"..tonumber(NexusIcons[Image])
		...
		function Tab:CreateColorPicker(ColorPickerSettings) -- by Throit
			...
			Input.SliderPoint.MouseButton1Down:Connect(function()
				sliderDragging = true 
			end)
			...
			local function setDisplay()
				...
				--Slider 
				local x = h * Input.AbsoluteSize.X
				Input.SliderPoint.Position = UDim2.new(0,x-Input.SliderPoint.AbsoluteSize.X/2,0.5,0)
				Input.SliderPoint.ImageColor3 = Color3.fromHSV(h,1,1)
				local color = Color3.fromHSV(h,s,v) 
			...
			game:GetService("RunService").RenderStepped:connect(function()
				...
				if sliderDragging then 
					local localX = math.clamp(mouse.X-Input.AbsolutePosition.X,0,Input.AbsoluteSize.X)
					h = localX / Input.AbsoluteSize.X
					Display.BackgroundColor3 = Color3.fromHSV(h,s,v)
					Input.SliderPoint.Position = UDim2.new(0,localX-Input.SliderPoint.AbsoluteSize.X/2,0.5,0)
					Input.SliderPoint.ImageColor3 = Color3.fromHSV(h,1,1)
					Background.BackgroundColor3 = Color3.fromHSV(h,1,1)
					Main.MainPoint.ImageColor3 = Color3.fromHSV(h,s,v)
					local color = Color3.fromHSV(h,s,v) 
		...
		function Tab:CreateInput(InputSettings)
			...
			local function calculateTextSize()
				return TextService:GetTextSize( Input.InputFrame.InputBox.Text,  Input.InputFrame.InputBox.TextSize,  Input.InputFrame.InputBox.Font, Vector2.new(math.huge,  Input.InputFrame.InputBox.AbsoluteSize.Y))
			end
			
			if Input.InputFrame.InputBox.Text:len() > 0 then
				if tonumber(calculateTextSize().X + 24) <= 255 then
					Input.InputFrame.Size = UDim2.new(0, calculateTextSize().X + 24, 0, 30)
				else
					Input.InputFrame.Size = UDim2.new(0, 255, 0, 30)
				end
			else
				Input.InputFrame.Size = UDim2.new(0, 15 * tonumber(tostring(InputSettings.PlaceholderText):len()) , 0, 30)
			end
			...
			Input.InputFrame.InputBox.FocusLost:Connect(function()
				...
				if not Success then
					...
					warn("Rayfield | "..InputSettings.Name.." Callback Error " ..tostring(Response))
					task.wait(0.5)
					Input.Title.Text = InputSettings.Name
			...
			Input.InputFrame.InputBox:GetPropertyChangedSignal("Text"):Connect(function()
				if Input.InputFrame.InputBox.Text:len() > 0 then
					if tonumber(calculateTextSize().X + 24) <= 255 then
						...
						TweenService:Create(Input.InputFrame, TweenInfo.new(0.55, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {Size = UDim2.new(0, 255, 0, 30)}):Play()
					end
				else
					TweenService:Create(Input.InputFrame, TweenInfo.new(0.55, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {Size = UDim2.new(0, 15 * tonumber(tostring(InputSettings.PlaceholderText):len()) , 0, 30)}):Play()
				end
			end)
		...
		function Tab:CreateDropdown(DropdownSettings)
			...
			if DropdownSettings.MultipleOptions then
				...
				for i,v in pairs(DropdownSettings.CurrentOption) do
					if tostring(v):len() > 0 then
						table.insert(CurrOps,v)
					end
				end
				DropdownSettings.CurrentOption = CurrOps
			...
			Dropdown.Size = UDim2.new(1, -10,-0.334, 180)
			...
			Dropdown.Interact.MouseButton1Click:Connect(function()
				...
				if Dropdown.List.Visible then
					Debounce = true
					TweenService:Create(Dropdown, TweenInfo.new(0.5, Enum.EasingStyle.Quint), {Size = UDim2.new(1, -10,-0.334, 180)}):Play()
					...
					for _, DropdownOpt in ipairs(Dropdown.List:GetChildren()) do
						if DropdownOpt.ClassName == "Frame" and DropdownOpt.Name ~= "Placeholder" then
							...
							if DropdownOpt:FindFirstChild("Interact") then
								...
								if (DropdownSettings.MultipleOptions and table.find(DropdownSettings.CurrentOption, DropdownOpt.Name)) or (not DropdownSettings.MultipleOptions and DropdownSettings.CurrentOption == DropdownOpt.Name) then
			...
			for _, Option in ipairs(DropdownSettings.Options) do
				...
				if (DropdownSettings.MultipleOptions and table.find(DropdownSettings.CurrentOption, Option)) or (not DropdownSettings.MultipleOptions and DropdownSettings.CurrentOption == Option) then
				...
				DropdownOption.Interact.Button.MouseButton1Click:Connect(function()
					if (DropdownSettings.MultipleOptions and not table.find(DropdownSettings.CurrentOption, Option)) or (not DropdownSettings.MultipleOptions and DropdownSettings.CurrentOption ~= Option) then
						...
						if not Success then
							...
							warn("Rayfield | "..DropdownSettings.Name.." Callback Error " ..tostring(Response))
							task.wait(0.5)
							Dropdown.Title.Text = DropdownSettings.Name
							TweenService:Create(Dropdown, TweenInfo.new(0.6, Enum.EasingStyle.Quint), {BackgroundColor3 = SelectedTheme.ElementBackground}):Play()
			...
			function DropdownSettings:Set(NewOption)
				if DropdownSettings.MultipleOptions then
					local CurrOps = {}
					for i,v in pairs(NewOption) do
						if tostring(v):len() > 0 then
							table.insert(CurrOps,v)
						end
					end
					Dropdown.Selected.Text = table.concat(CurrOps, ", ")
				else
				...
				for _, droption in ipairs(Dropdown.List:GetChildren()) do
					if (DropdownSettings.MultipleOptions and not table.find(NewOption, droption.Name)) or (not DropdownSettings.MultipleOptions and droption.Name ~= NewOption) then
						if droption.ClassName == "Frame" and droption.Name ~= "Placeholder" and droption.Name ~= "Search" then
			...
			function DropdownSettings:UpdateOptions(NewOptions)
				...
				for _, Option in ipairs(DropdownSettings.Options) do
					local DropdownOption2 = Elements.Template.Dropdown.List.Template:Clone()
					DropdownOption2.Name = Option
					DropdownOption2.Title.Text = Option
					DropdownOption2.Parent = Dropdown.List
					DropdownOption2.Visible = true

					if (DropdownSettings.MultipleOptions and table.find(DropdownSettings.CurrentOption, Option)) or (not DropdownSettings.MultipleOptions and DropdownSettings.CurrentOption == Option) then
						DropdownOption2.BackgroundColor3 = Color3.fromRGB(40, 40, 40)
					end

					DropdownOption2.BackgroundTransparency = 1
					DropdownOption2.UIStroke.Transparency = 1
					DropdownOption2.Title.TextTransparency = 1

					if DropdownOption2:FindFirstChild("Interact") then
						--pcall(function()
						DropdownOption2.Interact.ZIndex = 50
							DropdownOption2.Interact.Button.MouseButton1Click:Connect(function()
								if (DropdownSettings.MultipleOptions and not table.find(DropdownSettings.CurrentOption, Option)) or (not DropdownSettings.MultipleOptions and DropdownSettings.CurrentOption ~= Option) then
									if DropdownSettings.MultipleOptions then
										table.insert(DropdownSettings.CurrentOption, Option)
										local CurrOps = {}
									...
									for _, droption in ipairs(Dropdown.List:GetChildren()) do
										...
										if droption.ClassName == "Frame" and droption.Name ~= "Placeholder" and droption.Name ~= "Search" then
											if droption.Interact.UIStroke.Color == Color3.fromRGB(62, 158, 231) and droption.Name ~= DropdownOption2 then
												TweenService:Create(droption.Interact.UIStroke, TweenInfo.new(0.3, Enum.EasingStyle.Quint), {Color = Color3.fromRGB(50, 50, 50)}):Play()
												TweenService:Create(droption.Interact.Icon, TweenInfo.new(0.3, Enum.EasingStyle.Quint), {ImageTransparency = 1}):Play()
												TweenService:Create(droption.Interact.Shadow, TweenInfo.new(0.3, Enum.EasingStyle.Quint), {ImageTransparency = 1}):Play()
												TweenService:Create(droption.Interact, TweenInfo.new(0.3, Enum.EasingStyle.Quint), {BackgroundColor3 = Color3.fromRGB(35, 35, 35)}):Play()
									...
									if DropdownOption2.Interact.UIStroke.Color == Color3.fromRGB(62, 158, 231) then
										TweenService:Create(DropdownOption2.Interact.UIStroke, TweenInfo.new(0.3, Enum.EasingStyle.Quint), {Color = Color3.fromRGB(50, 50, 50)}):Play()
										TweenService:Create(DropdownOption2.Interact.Icon, TweenInfo.new(0.3, Enum.EasingStyle.Quint), {ImageTransparency = 1}):Play()
										TweenService:Create(DropdownOption2.Interact.Shadow, TweenInfo.new(0.3, Enum.EasingStyle.Quint), {ImageTransparency = 1}):Play()
										TweenService:Create(DropdownOption2.Interact, TweenInfo.new(0.3, Enum.EasingStyle.Quint), {BackgroundColor3 = Color3.fromRGB(35, 35, 35)}):Play()
									else
										TweenService:Create(DropdownOption2.Interact.UIStroke, TweenInfo.new(0.3, Enum.EasingStyle.Quint), {Color = Color3.fromRGB(62, 158, 231)}):Play()
										TweenService:Create(DropdownOption2.Interact.Icon, TweenInfo.new(0.3, Enum.EasingStyle.Quint), {ImageTransparency = 0}):Play()
										TweenService:Create(DropdownOption2.Interact.Shadow, TweenInfo.new(0.3, Enum.EasingStyle.Quint), {ImageTransparency = 0.7}):Play()
										TweenService:Create(DropdownOption2.Interact, TweenInfo.new(0.3, Enum.EasingStyle.Quint), {BackgroundColor3 = Color3.fromRGB(43, 105, 159)}):Play()
									end
									...
									-- Debounce = true
									-- task.wait(0.2)
									-- TweenService:Create(DropdownOption2.UIStroke, TweenInfo.new(0.3, Enum.EasingStyle.Quint), {Transparency = 0}):Play()
									-- task.wait(0.1)
									-- TweenService:Create(Dropdown, TweenInfo.new(0.5, Enum.EasingStyle.Quint), {Size = UDim2.new(1, -10, 0, 45)}):Play()
									-- for _, DropdownOpt in ipairs(Dropdown.List:GetChildren()) do
									-- 	if DropdownOpt.ClassName == "Frame" and DropdownOpt.Name ~= "Placeholder" then
									...
									print(DropdownOption2.Name,"found")
									if DropdownSettings.MultipleOptions then
										for i2,v2 in pairs(DropdownSettings.CurrentOption) do
											if v2 == Option then
												table.remove(DropdownSettings.CurrentOption, i2)
									...
									print("no work")
									TweenService:Create(DropdownOption2.UIStroke, TweenInfo.new(0.3, Enum.EasingStyle.Quint), {Transparency = 1}):Play()
									TweenService:Create(DropdownOption2, TweenInfo.new(0.3, Enum.EasingStyle.Quint), {BackgroundColor3 = Color3.fromRGB(40, 40, 40)}):Play()
			...
			for i, Rule in ipairs(ListSettings.Rules) do
				...
				DropdownOption:FindFirstChild("Remove").MouseButton1Click:Connect(function()
					...
					if not Success then
						...
						warn("Rayfield | "..ListSettings.Name.." Callback Error " ..tostring(Response))
						task.wait(0.5)
						ListClone.Title.Text = ListSettings.Name
						TweenService:Create(ListClone, TweenInfo.new(0.6, Enum.EasingStyle.Quint), {BackgroundColor3 = SelectedTheme.ElementBackground}):Play()
				...
				elseif KeybindSettings.CurrentKeybind ~= nil and (Input.KeyCode == Enum.KeyCode[KeybindSettings.CurrentKeybind] and not processed) then -- Test
					...
					if not KeybindSettings.HoldToInteract then
						...
						if not Success then
							...
							warn("Rayfield | "..KeybindSettings.Name.." Callback Error " ..tostring(Response))
							task.wait(0.5)
							Keybind.Title.Text = KeybindSettings.Name
							TweenService:Create(Keybind, TweenInfo.new(0.6, Enum.EasingStyle.Quint), {BackgroundColor3 = SelectedTheme.ElementBackground}):Play()
		...
		function Tab:CreateSlider(SliderSettings)
			...
			if not SliderSettings.Suffix then
				Slider.InputFrame.InputBox.Text = tostring(SliderSettings.CurrentValue)
			else
				Slider.InputFrame.InputBox.Text = tostring(SliderSettings.CurrentValue) .. " " .. SliderSettings.Suffix
			end

			local function calculateTextSize()
				return TextService:GetTextSize( Slider.InputFrame.InputBox.Text,  Slider.InputFrame.InputBox.TextSize,  Slider.InputFrame.InputBox.Font, Vector2.new(math.huge,  Slider.InputFrame.InputBox.AbsoluteSize.Y))
			end
			
			if Slider.InputFrame.InputBox.Text:len() > 0 then
				if tonumber(calculateTextSize().X + 24) <= 255 then
					Slider.InputFrame.Size = UDim2.new(0, calculateTextSize().X + 24, 0, 30)
				else
					Slider.InputFrame.Size = UDim2.new(0, 255, 0, 30)
				end
			else
				if not SliderSettings.Suffix then
					Slider.InputFrame.Size = UDim2.new(0, 15 * tonumber(tostring(SliderSettings.CurrentValue):len()) , 0, 30)
				else
					Slider.InputFrame.Size = UDim2.new(0, 10 * tonumber(tostring(SliderSettings.CurrentValue) .. " " .. SliderSettings.Suffix:len()) , 0, 30)
				end
			...
			Slider.InputFrame.InputBox.FocusLost:Connect(function()
				if not tonumber(Slider.InputFrame.InputBox.Text) then return end

				if tonumber(Slider.InputFrame.InputBox.Text) < tonumber(SliderSettings.Range[2]) then
					local NewVal = tonumber(Slider.InputFrame.InputBox.Text)

					if SliderSettings.Suffix then
						Slider.InputFrame.InputBox.Text = tostring(Slider.InputFrame.InputBox.Text) .. " " .. SliderSettings.Suffix
					end
					...
					local NewVal = SliderSettings.Range[2]

					if SliderSettings.Suffix then
						Slider.InputFrame.InputBox.Text = tostring(SliderSettings.Range[2]) .. " " .. SliderSettings.Suffix
					end
			...
			Slider.InputFrame.InputBox:GetPropertyChangedSignal("Text"):Connect(function()
				if Slider.InputFrame.InputBox.Text:len() > 0 then
					if tonumber(calculateTextSize().X + 24) <= 255 then
						TweenService:Create(Slider.InputFrame, TweenInfo.new(0.55, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {Size = UDim2.new(0, calculateTextSize().X + 24, 0, 30)}):Play()
					else
						TweenService:Create(Slider.InputFrame, TweenInfo.new(0.55, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {Size = UDim2.new(0, 255, 0, 30)}):Play()
					end
				else
					TweenService:Create(Slider.InputFrame, TweenInfo.new(0.55, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {Size = UDim2.new(0, 15 * tonumber(tostring(InputSettings.PlaceholderText):len()) , 0, 30)}):Play()
				end
			end)
			...
			Slider.Main.Interact.MouseButton1Down:Connect(function(X)
				...
				local Loop; Loop = RunService.Stepped:Connect(function()
					if Dragging then
						...
						if not SliderSettings.Suffix then
							Slider.InputFrame.InputBox.Text = tostring(NewValue)
						else
							Slider.InputFrame.InputBox.Text = tostring(NewValue) .. " " .. SliderSettings.Suffix
						end
						...
						if SliderSettings.CurrentValue ~= NewValue then
							...
							if not Success then
								...
								warn("Rayfield | "..SliderSettings.Name.." Callback Error " ..tostring(Response))
								task.wait(0.5)
								Slider.Title.Text = SliderSettings.Name
								TweenService:Create(Slider, TweenInfo.new(0.6, Enum.EasingStyle.Quint), {BackgroundColor3 = SelectedTheme.ElementBackground}):Play()
						...
						TweenService:Create(Slider.Main.Progress, TweenInfo.new(0.45, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {Size = UDim2.new(0, Location - Slider.Main.AbsolutePosition.X > 5 and Location - Slider.Main.AbsolutePosition.X or 5, 1, 0)}):Play()
						Loop:Disconnect()
					end
				end)
			end)
			...
			function SliderSettings:Set(NewVal)
				TweenService:Create(Slider.Main.Progress, TweenInfo.new(0.45, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {Size = UDim2.new(0, Slider.Main.AbsoluteSize.X * ((NewVal + SliderSettings.Range[1]) / (SliderSettings.Range[2] - SliderSettings.Range[1])) > 5 and Slider.Main.AbsoluteSize.X * (NewVal / (SliderSettings.Range[2] - SliderSettings.Range[1])) or 5, 1, 0)}):Play()
				Slider.InputFrame.InputBox.Text = tostring(NewVal) .. " " .. SliderSettings.Suffix
				local Success, Response = pcall(function()
					SliderSettings.Callback(NewVal)
				end)
				if not Success then
					TweenService:Create(Slider, TweenInfo.new(0.6, Enum.EasingStyle.Quint), {BackgroundColor3 = Color3.fromRGB(85, 0, 0)}):Play()
					TweenService:Create(Slider.Slider.UIStroke, TweenInfo.new(0.6, Enum.EasingStyle.Quint), {Transparency = 1}):Play()
					Slider.Title.Text = "Callback Error"
					warn("Rayfield | "..SliderSettings.Name.." Callback Error " ..tostring(Response))
					task.wait(0.5)
					Slider.Title.Text = SliderSettings.Name
			...
			function SliderSettings:Visible(Visiblity)

				if type(Visiblity) == "boolean" then
					Slider.Visible = Visiblity
				end
	...
	task.wait(0.2)
	TweenService:Create(Main, TweenInfo.new(0.7, Enum.EasingStyle.Quint), {Size = UDim2.new(0, 464, 0, 440)}):Play()
	TweenService:Create(Main.Shadow.Image, TweenInfo.new(0.7, Enum.EasingStyle.Quint), {ImageTransparency = 0.4}):Play()
